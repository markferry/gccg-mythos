...
Send("Say","{orange} *** Metw Deck Statistics *** ");

Send("Say","{gray}Hazards{green}: {white}" + format("%2.0f",CountHazards(curdeck))
...
Send("Say","{blue}Pool Statistics{green}: {white}" + format("%2.0f",CountHazards(curdeck))
 + " {green}({white}"  + format("%2.0f",(CountHazards(curdeck)/totalcards)*100)  + "%{green})"
 + " {gold}Hero Resources{green}: {white}" + format("%2.0f",CountResources(curdeck))
 + " {green}({white}" + format("%2.0f",(CountResources(curdeck)/totalcards)*100) + "%{green})"
 + " {cyan}Minion Resources{green}: {white}" + format("%2.0f",CountMinionRes(curdeck))
...
Send("Say","{gray}Hazard Statistics{green}: {yellow}Creatures{green}={white}"+format("%2.0f",CountHazCreatures(curdeck))
...
Send("Say","{gold}Resource Statistics{green}: {yellow}Short-Events={white}"+format("%2.0f",CountResShort(curdeck))
...
Send("Say","{yellow}Items={white}"+format("%2.0f",CountResItems(curdeck))
...
Send("Say","{red}Marshalling Points{green}: {cyan}Characters{green}={white}"
